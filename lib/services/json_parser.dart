...
class JsonParser {
  ...
  static Future<NotificationModel> parseNotificationJson(
    String jsonString,
  ) async {
    ...
    await Isolate.spawn(
      ...
      _IsolateData(sendPort: receivePort.sendPort, jsonString: jsonString),
    );
...
class _IsolateData {
  ...
  _IsolateData({required this.sendPort, required this.jsonString});
}
